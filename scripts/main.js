...
// // define function remove bookmark
...
// define function update bookmark
function updateBookmark(hikeDocID) {
    if (document.getElementById('save-' + hikeDocID).innerText == 'bookmark_border') {
        saveBookmark(hikeDocID);
    }
    else {
        removeBookmark(hikeDocID);
    }
}
